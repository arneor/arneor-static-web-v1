          ...
          <div className="container">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground text-balance">
                ...
                to discuss your next project and explore partnership opportunities.
              </p>
            </div>
          </div>
        </section>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">hello@arneor.com</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Most projects take 3-6 months depending on complexity. We'll provide 
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Absolutely! We love working with startups and can provide flexible 
                        engagement models to fit your budget and timeline.
                      </p>
                    </div>
                    <div>
                      <h4 className="font-medium mb-1">What technologies do you specialize in?</h4>
                      <p className="text-sm text-muted-foreground">
                        We specialize in Flutter for mobile apps, React for web applications, 
                        and Firebase/Node.js for backend development.
                      </p>
                    </div>
                  </CardContent>
                </Card>
          ...
          <div className="container">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Join the growing list of businesses that trust ARNEOR to bring their 
