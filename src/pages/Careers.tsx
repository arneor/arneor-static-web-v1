...
const Careers = () => {
  const openPositions = [
    {
      ...
      description: "Join our mobile development team to build cutting-edge cross-platform applications using Flutter.",
    ...
    },
    {
      ...
      description: "Work on our SaaS applications, building both frontend and backend components using modern technologies.",
    ...
    },
    {
      ...
      description: "Design intuitive user experiences for our growing portfolio of SaaS and mobile applications.",
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Fast-track your career with mentorship and learning opportunities."
    },
    {
      icon: Heart,
    ...
    },
    {
      ...
      description: "Work with passionate individuals who share your love for technology."
    }
  ];
          ...
          <div className="container">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground text-balance">
                Join a dynamic team of innovators creating cutting-edge SaaS applications 
                and mobile solutions that make a real impact on businesses worldwide.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                ...
                and want to make a difference in the world of software development.
              </p>
            </div>

            <div className="space-y-6 max-w-4xl mx-auto">
              {openPositions.map((position, index) => (
                <Card key={index} className="hover:shadow-brand transition-all duration-300">
                  <CardHeader>
        ...
        <section className="py-20 bg-secondary/50">
          <div className="container">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                We believe in creating an environment where our team can thrive both 
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-muted-foreground">
                  At ARNEOR, we foster a culture of innovation, collaboration, and continuous learning.
                </p>
              </div>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      We encourage our team to explore new technologies, experiment with innovative 
                      solutions, and push the boundaries of what's possible in software development.
                    </p>
                  </div>
                  <div>
                    <h3 className="text-2xl font-semibold mb-4">Work-Life Balance</h3>
                    <p className="text-muted-foreground">
                      We believe that great work comes from individuals who are fulfilled both 
                      professionally and personally. That's why we offer flexible working arrangements 
                      and respect personal time.
                    </p>
                  </div>
                  <div>
                    <h3 className="text-2xl font-semibold mb-4">Continuous Learning</h3>
                    <p className="text-muted-foreground">
                      Technology evolves rapidly, and so do we. We provide resources, time, and 
                      support for our team members to continuously upgrade their skills and knowledge.
                    </p>
                  </div>
                </div>
                <div className="space-y-4">
                  ...
                  <Card className="bg-gradient-hero">
                    <CardContent className="p-6">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Work on projects that make a real difference to users and businesses
                      </p>
                    </CardContent>
                  </Card>
                </div>
