  ...
  const services = [
    {
      ...
      description:
        'End-to-end development of scalable Software-as-a-Service applications with modern architecture.',
      features: [
    ...
    },
    {
      ...
      description:
        'Cross-platform mobile applications using Flutter for superior performance and user experience.',
      features: [
    ...
    },
    {
      ...
      description:
        'Robust backend systems with secure APIs and efficient database management solutions.',
      features: [
    ...
    },
    {
      ...
      description:
        'Strategic technology guidance for digital transformation and growth optimization.',
      features: [
          ...
          <div className='container'>
            <div className='max-w-4xl mx-auto text-center'>
              ...
              <p className='text-xl text-muted-foreground text-balance'>
                We specialize in building innovative SaaS applications and
                mobile solutions that empower businesses to achieve their
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
              {services.map((service, index) => {
                ...
                return (
                  <Card
                    key={index}
                    className='hover:shadow-brand transition-all duration-300 group'>
                    <CardHeader>
                ...
                {[
                  {
                    ...
                    description:
                      'Successfully delivered UNEVEE, our flagship SaaS platform serving hundreds of users.',
                    icon: CheckCircle,
                  },
                  {
                    title: 'Modern Technology Stack',
                    description:
                      'We use cutting-edge technologies like Flutter, React, and Firebase for optimal results.',
                    icon: Code,
                  },
                  {
