  ...
  const services = [
    {
      ...
      description:
        'End-to-end SaaS application development with modern architecture and scalable solutions.',
      features: [
        'Cloud Architecture',
        'API Development',
        'User Management',
    ...
    },
    {
      ...
      title: 'Backend & API',
      description:
        'Robust backend systems with secure APIs and efficient database management.',
      features: [
        'RESTful APIs',
        'Database Design',
      ...
      <div className='container'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-muted-foreground max-w-3xl mx-auto'>
            We specialize in building innovative SaaS applications and mobile
