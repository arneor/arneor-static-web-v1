      ...
      <div className='container'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-muted-foreground max-w-3xl mx-auto'>
            Discover our flagship projects and the innovative solutions we've
            built to transform businesses and improve lives.
          </p>
        </div>
          ...
          <Card className='overflow-hidden shadow-brand hover:shadow-lg transition-all duration-300'>
            <CardHeader>
              ...
              <CardDescription className='text-base'>
                Comprehensive health, fitness, and management platform serving
            ...
            <CardContent className='space-y-6'>
              ...
              <div className='space-y-3'>
                ...
                <div className='flex flex-wrap gap-2'>
                  {['E-commerce', 'EdTech', 'FinTech', 'Healthcare'].map(
                    (area) => (
                      <Badge
                        key={area}
                        variant='secondary'>
